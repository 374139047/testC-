	...
	public class MainForm : System.Windows.Forms.Form
	{
		...
		public MainForm()
		{
			...
			try 
			{
				...
				//using the method "GetLogicalDrives()"
		...
		private void btnUp_Click(object sender, System.EventArgs e)
		{
			try 
			{
				if(CurPath.Count>1) 
				{
					//Current path is not root directory
		...
		private void DeleteMethod(object sender, System.EventArgs e) {
			try 
			{
				...
				//Delete the folder
				//test
				//MessageBox.Show(FilesView.SelectedItems[0].SubItems[0].Text);
		...
		//add for test
		//if the delete key is pressed, call the delete method
